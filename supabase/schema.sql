...
create table public.league_point_settings (
  id uuid primary key default gen_random_uuid(),
  league_id uuid not null unique references public.leagues(id) on delete cascade,
  match_exact_score_points int not null default 3,
  match_goal_difference_points int not null default 3,
  match_sign_points int not null default 2,
  group_exact_position_points int not null default 3,
  group_winner_bonus_points int not null default 0,
  group_qualified_team_points int not null default 5,
  best_third_team_points int not null default 5,
  knockout_round_32_reached_points int not null default 5,
  knockout_round_16_reached_points int not null default 8,
  knockout_quarter_reached_points int not null default 12,
  knockout_semi_reached_points int not null default 18,
  knockout_final_reached_points int not null default 25,
  knockout_champion_points int not null default 60,
  knockout_runner_up_points int not null default 35,
  knockout_third_place_points int not null default 20,
  live_round_32_sign_points int not null default 4,
  live_round_32_winner_points int not null default 8,
  live_round_32_goal_difference_points int not null default 4,
  live_round_32_exact_score_bonus int not null default 2,
  live_round_16_sign_points int not null default 4,
  live_round_16_winner_points int not null default 12,
  live_round_16_goal_difference_points int not null default 4,
  live_round_16_exact_score_bonus int not null default 2,
  live_quarter_sign_points int not null default 4,
  live_quarter_winner_points int not null default 18,
  live_quarter_goal_difference_points int not null default 4,
  live_quarter_exact_score_bonus int not null default 2,
  live_semi_sign_points int not null default 4,
  live_semi_winner_points int not null default 25,
  live_semi_goal_difference_points int not null default 4,
  live_semi_exact_score_bonus int not null default 2,
  live_third_place_sign_points int not null default 4,
  live_third_place_winner_points int not null default 0,
  live_third_place_goal_difference_points int not null default 4,
  live_third_place_exact_score_bonus int not null default 2,
  live_final_sign_points int not null default 6,
  live_final_winner_points int not null default 0,
  live_final_goal_difference_points int not null default 6,
  live_final_exact_score_bonus int not null default 4,
  ...
  award_best_player_points int not null default 25,
  award_best_goalkeeper_points int not null default 15,
  award_best_young_player_points int not null default 15
);
