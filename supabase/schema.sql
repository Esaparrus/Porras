...
create table public.league_point_settings (
  ...
  group_exact_position_points int not null default 1,
  group_winner_bonus_points int not null default 2,
  group_qualified_team_points int not null default 1,
  best_third_team_points int not null default 1,
  knockout_round_32_reached_points int not null default 1,
  knockout_round_16_reached_points int not null default 2,
  knockout_quarter_reached_points int not null default 3,
  knockout_semi_reached_points int not null default 5,
  knockout_final_reached_points int not null default 8,
  ...
  award_best_goalkeeper_points int not null default 6,
  award_best_young_player_points int not null default 6
);
