...
import { PROFILE_AVATAR_EMOJIS, type ProfileAvatarEmoji } from "@/lib/profile-avatars";
import {
...
export async function updateOwnProfileAction(formData: FormData) {
  ...
  const normalizedAvatarEmoji =
    avatarEmoji && PROFILE_AVATAR_EMOJIS.includes(avatarEmoji as ProfileAvatarEmoji)
      ? avatarEmoji
      : null;
